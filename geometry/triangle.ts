...
export class Triangle implements ITriangle, IPolygon {
    ...
    public get hash(): string { return Geometry.Triangle.Hash(this); }
    public get circumcircle(): ICircle { return Geometry.Triangle.Circumcircle(this); }
    public get triangulation(): ITriangle[] { return Geometry.Triangle.Triangulation(this); }
    public get areaSigned(): number { return Geometry.Triangle.AreaSigned(this); }
    public get area(): number { return Geometry.Triangle.Area(this); }
    public get bounds(): IRectangle { return Geometry.Triangle.Bounds(this); }
    public isEqualTo(triangle: ITriangle): boolean { return Geometry.Triangle.Hash(triangle) === this.hash; }
    
    public collidesPoint(point: IPoint): boolean { return Geometry.Collide.TrianglePoint(this, point); }
    public lineIntersections(line: ILine): Point[] { return Triangle.intersections(this, line, PointPairType.LINE); }
    public rayIntersections(ray: IRay): Point[] { return Triangle.intersections(this, ray, PointPairType.RAY); }
    public segmentIntersections(segment: ISegment): Point[] { return Triangle.intersections(this, segment, PointPairType.SEGMENT); }
