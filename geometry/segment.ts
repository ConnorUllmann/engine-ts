...
export class Segment implements ISegment {
  public static Create(segment: ISegment): Segment {
    return new Segment(Point.Create(segment.a), Point.Create(segment.b));
  }
  ...
  public get hash(): string {
    return Geometry.Segment.Hash(this);
  }
  public isEqualTo(segment: ISegment): boolean {
    return Geometry.Segment.AreEqual(this, segment);
  }
  public get midpoint(): IPoint {
    return this.a.midpoint(this.b);
  }
  public get slope(): number {
    return Geometry.Segment.Slope(this);
  }
  public YatX(x: number): number | null {
    return Geometry.Segment.YatX(this, x);
  }
